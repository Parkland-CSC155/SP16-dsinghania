...
readDirAsync(rawFolder, function(err1, rawFilesArray){
    ...
    rawFilesArray.forEach(function(file) {
        ...
        if(file.startsWith("2014")) {
            ...
            reNameFileAsync(oldPath, newPath1, function(){
        ...
        if(file.startsWith("2015")) {
            ...
            reNameFileAsync(oldPath, newPath2, function(){
        ...
        if(file.startsWith("2016")) {
            ...
            reNameFileAsync(oldPath, newPath3, function(){
                //console.log("2016 file moved");
            });
            ctr1++;
        }
    });
    //console.log("ctr1 outside for each loop is: " + ctr1);
...
function reNameFileAsync(oldPath, newPath, callback) {
